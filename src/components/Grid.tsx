    ...
    () => [
      ...
      },
      {
        ...
        cell: (info) => {
          ...
          return url ? (
            <a href={`https://${url}`} target="_blank" className="text-blue-500 underline">
              {url}
            </a>
          ) : null;
        },
      ...
      },
      {
        ...
        header: () => (
          <div className="flex items-center gap-1 text-gray-600 font-semibold py-1 rounded">
            Priority
          </div>
        ),
        cell: (info) => {
      ...
      },
      {
        ...
        header: () => <div className="text-orange-800 font-semibold text-sm">Est. Value</div>,
      },
    ],
    []
  );
        ...
        <table className="table-fixed min-w-full text-sm border-collapse">
          <thead>
            <tr className="text-sm">
              ...
              <th
                className="border-r border-b border-gray-300 bg-green-100 hover:cursor-pointer"
                onClick={() => {
                  console.log('ABC');
                }}
              >
              ...
              <th
                colSpan={2}
                className="border-r border-b border-gray-300 bg-purple-100 hover:cursor-pointer"
                onClick={() => {
              ...
              <th
                className="border-r border-b border-gray-300 bg-orange-100 hover:cursor-pointer"
                onClick={() => {
                  console.log('Extract');
                }}
              >
              ...
              <th
                className="border-r border-b border-gray-300 bg-gray-100 text-center w-10 hover:cursor-pointer hover:bg-gray-200"
                onClick={() => {
                  console.log('Plus');
                }}
              >
            ...
            {table.getHeaderGroups().map((headerGroup) => (
              <tr key={headerGroup.id}>
                {headerGroup.headers.map((header) => (
                  <th
                    key={header.id}
                    className={`border-r border-b border-gray-300 px-2 py-1 font-medium text-left ${
                      header.id === 'assigned'
